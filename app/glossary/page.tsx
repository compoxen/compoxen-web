...
const TERMS: DefinedTerm[] = [
  ...
  { term: 'Service area', definition: 'The geography Compoxen installs in. Currently all of Utah — Salt Lake, Utah, Davis, Weber, Tooele, Wasatch, Summit, and Cache counties. Material ships anywhere in the continental U.S.' },
