          ...
          >
            ...
            <div style={{ display: 'grid', gap: '18px' }}>
              ...
              <div style={{
                ...
                <a href="/find-installer" style={{ textDecoration: 'none', color: 'inherit' }}>
                  Homeowner? <span style={{ textDecoration: 'underline' }}>Click here</span>
                </a>
                <a href="/dealer-login" style={{ textDecoration: 'none', color: 'inherit' }}>
                  Already a dealer? <span style={{ textDecoration: 'underline' }}>Sign in</span>
                </a>
              </div>
            </div>
            ...
            >
              ...
              <div><Check size={14} color="#D97706" /> Dealer Support</div>
            </div>
          </div>
        </div>
      </section>
