          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 lg:gap-8 justify-items-center">
            {[
              ...
              >
                ...
                <div className="text-gray-900 font-semibold text-sm sm:text-base mb-1 text-center">{color.name}</div>
                <div className="text-gray-500 text-xs sm:text-sm leading-relaxed text-center">{color.note}</div>
              </motion.div>
            ))}
          </div>
        </div>
